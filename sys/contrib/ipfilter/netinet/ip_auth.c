/*	$FreeBSD: head/sys/contrib/ipfilter/netinet/ip_auth.c 255332 2013-09-06 23:11:19Z cy $	*/
...
#if !defined(lint)
static const char rcsid[] = "@(#)$FreeBSD: head/sys/contrib/ipfilter/netinet/ip_auth.c 255332 2013-09-06 23:11:19Z cy $";
